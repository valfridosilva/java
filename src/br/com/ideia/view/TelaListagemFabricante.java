 ...
 *
 */
public class TelaListagemFabricante extends JInternalFrame {
	...
	public TelaListagemFabricante(TelaMenu telaMenu, List<FabricanteVO> lista,final TelaFabricante tela){	
