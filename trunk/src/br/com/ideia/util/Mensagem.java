...
public class Mensagem {
	...
	public static final String CLIENTE_DUPLICADO = "Já existe um usuário com mesmo nome e telefone";
	public static final String REGISTRO_DUPLICADO = "Já existe um(a) %S com a mesma descrição!";
